...
public:
    ...
    Q_PROPERTY(QObject* customOSDSettings               READ customOSDSettings              CONSTANT)
    ...
    CustomOSDSettings*              customOSDSettings           (void) { return _customOSDSettings; }
#if !defined(NO_ARDUPILOT_DIALECT)
...
private:
    ...
    CustomOSDSettings*              _customOSDSettings;
#if !defined(NO_ARDUPILOT_DIALECT)
